...
import { S as ShieldCheck, i as BookOpen, j as MessageSquareWarning, b as ArrowRight } from "../_libs/lucide-react.mjs";
...
const eduardoImg = "/assets/eduardo-brito-D-xcd_h5.webp";
function EticaPage() {
  const {
    t
  } = useTranslation();
