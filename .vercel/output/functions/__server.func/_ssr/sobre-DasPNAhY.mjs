...
import { S as SiteShell, r as raioSolid } from "./raio-solid-gradient-CmvUkfnx.mjs";
import { P as PageHero } from "./PageHero-mJLbcV0P.mjs";
import { B as BoltDecor } from "./BoltDecor-nbSoyMw9.mjs";
import { R as Reveal, S as Stagger, a as StaggerItem, e as easeOut } from "./router-CoUV5MU4.mjs";
import "../_libs/i18next.mjs";
import { u as useTranslation, T as Trans } from "../_libs/react-i18next.mjs";
import { T as Target, E as Eye, h as Sparkles } from "../_libs/lucide-react.mjs";
...
const width$4 = 480;
const height$4 = 720;
const src$4 = "/assets/eduardo-brito-d5_bAiZf.webp";
const eduardoMeta = { width: width$4, height: height$4, src: src$4 };
const eduardoSrcSet = "/assets/eduardo-brito-C6xvrvvt.webp 320w, /assets/eduardo-brito-d5_bAiZf.webp 480w, /assets/eduardo-brito-C9xjWsXk.webp 640w";
const eduardoBlur = "/assets/eduardo-brito-gEJnr8bO.webp";
const width$3 = 325;
const height$3 = 325;
const src$3 = "/assets/fernando-oliveira-Bf5mnJS-.webp";
const fernandoMeta = { width: width$3, height: height$3, src: src$3 };
const fernandoSrcSet = "/assets/fernando-oliveira-CUQ5rjwO.webp 320w, /assets/fernando-oliveira-Bf5mnJS-.webp 325w";
const fernandoBlur = "/assets/fernando-oliveira-D40illN6.webp";
const width$2 = 480;
const height$2 = 720;
const src$2 = "/assets/juliana-scalzo-qanCakYf.webp";
const julianaMeta = { width: width$2, height: height$2, src: src$2 };
const julianaSrcSet = "/assets/juliana-scalzo-sFTH44-N.webp 320w, /assets/juliana-scalzo-qanCakYf.webp 480w, /assets/juliana-scalzo-CJDwhphe.webp 640w";
const julianaBlur = "/assets/juliana-scalzo-zVzZ_R5C.webp";
const width$1 = 480;
const height$1 = 720;
const src$1 = "/assets/italo-david-C7Cp_huy.webp";
const italoMeta = { width: width$1, height: height$1, src: src$1 };
const italoSrcSet = "/assets/italo-david-fwuGaCFD.webp 320w, /assets/italo-david-C7Cp_huy.webp 480w, /assets/italo-david-H9qYWEMQ.webp 640w";
const italoBlur = "/assets/italo-david-BkFDyNRU.webp";
const width = 480;
const height = 720;
const src = "/assets/tiago-cacozzi-lP1jY2h5.webp";
const tiagoMeta = { width, height, src };
const tiagoSrcSet = "/assets/tiago-cacozzi-BYzN2Izt.webp 320w, /assets/tiago-cacozzi-lP1jY2h5.webp 480w, /assets/tiago-cacozzi-CpCyBpTB.webp 640w";
const tiagoBlur = "/assets/tiago-cacozzi-Djz1ZQbV.webp";
const LEADERSHIP_PORTRAITS = [
...
const LEADERSHIP_PORTRAIT_SIZES = "(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw";
function SobrePage() {
  const {
    t
  } = useTranslation();
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden py-24", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-hrz relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stagger, { className: "mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-5", children: LEADERSHIP.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(StaggerItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-2xl border border-border bg-card transition hover:border-hrz-electric", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden bg-slate-50", style: {
            backgroundImage: `url(${l.portrait.blurSrc})`,
            backgroundSize: "cover",
            backgroundPosition: "center top"
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: l.portrait.src, srcSet: l.portrait.srcSet, sizes: LEADERSHIP_PORTRAIT_SIZES, width: l.portrait.width, height: l.portrait.height, alt: t("about.leadership.portraitAlt", {
            name: l.name
          }), loading: "lazy", decoding: "async", className: "aspect-[3/4] w-full rounded-t-2xl rounded-b-none object-cover object-center" }) }),
