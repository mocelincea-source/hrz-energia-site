...
function StaggerItem({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: staggerItem, className: className ? `will-change-transform will-change-opacity ${className}` : "will-change-transform will-change-opacity", children });
}
function Counter({
  to,
  prefix = "",
...
const appCss = "/assets/styles-Jl0Vr7AG.css";
...
const footer$1 = { "logoAlt": "HRZ energia", "linkedinLabel": "LinkedIn HRZ Energia", "socialLabel": "Compartilhar HRZ Energia", "cta": { "title": "Juntos, construímos um futuro mais sustentável.", "subtitle": "Fale com nosso time e saiba como a HRZ pode ser parceira da sua próxima oportunidade.", "button": "Fale com a HRZ" }, "brand": { "title": "HRZ Energia", "description": "Plataforma integrada de energia controlada pela Actis. Operamos ativos críticos de transmissão e geração renovável no Brasil com disciplina, governança e excelência técnica." }, "navigation": { "title": "Navegação" }, "contact": { "title": "Contato", "location": "São Paulo - Brasil", "email": "contato@hrzenergia.com.br", "phone": "+55 11 99922-3631", "button": "Fale com a HRZ" }, "copyright": "© {{year}} HRZ Energia. Todos os direitos reservados.", "controlled": "Controlada pela Actis · Global Sustainability Committee" };
const pt = {
  nav: nav$1,
  language: language$1,
  home: home$1,
...
const footer = { "logoAlt": "HRZ Energia", "linkedinLabel": "LinkedIn HRZ Energia", "socialLabel": "Share HRZ Energia", "cta": { "title": "Together, we build a more sustainable future.", "subtitle": "Talk to our team and learn how HRZ can partner on your next opportunity.", "button": "Contact HRZ" }, "brand": { "title": "HRZ Energia", "description": "An integrated energy platform controlled by Actis. We operate critical transmission and renewable generation assets in Brazil with discipline, governance, and technical excellence." }, "navigation": { "title": "Navigation" }, "contact": { "title": "Contact", "location": "São Paulo - Brazil", "email": "contato@hrzenergia.com.br", "phone": "+55 11 99922-3631", "button": "Contact HRZ" }, "copyright": "© {{year}} HRZ Energia. All rights reserved.", "controlled": "Controlled by Actis · Global Sustainability Committee" };
const en = {
  nav,
  language,
  home,
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "pt-BR", className: "scroll-smooth", children: [
...
const $$splitComponentImporter$9 = () => import("./transmissoras-WgEXs4WF.mjs");
...
const $$splitComponentImporter$8 = () => import("./sobre-B7GiqbXk.mjs");
...
const $$splitComponentImporter$7 = () => import("./portfolio-VlPaIWSJ.mjs");
...
const $$splitComponentImporter$6 = () => import("./investidores-B27mH-Q9.mjs");
...
const $$splitComponentImporter$5 = () => import("./etica-DEoB6yHn.mjs");
...
const $$splitComponentImporter$4 = () => import("./esg-C-XSh4We.mjs");
...
const $$splitComponentImporter$3 = () => import("./eolicas-D5NRgYVa.mjs");
...
const $$splitComponentImporter$2 = () => import("./empresas-Bg6_vM4X.mjs");
...
const $$splitComponentImporter$1 = () => import("./contato-DKMDfHNx.mjs");
...
const $$splitComponentImporter = () => import("./index-B_wi5HiW.mjs");
