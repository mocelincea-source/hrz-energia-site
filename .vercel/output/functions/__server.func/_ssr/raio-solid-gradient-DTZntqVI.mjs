...
import { g as ScrollProgressBar, h as PageTransition, e as easeOut, c as HERO_DURATION, d as HERO_BASE, l as logoWhite, f as HERO_STAGGER } from "./router-D2eUFBWB.mjs";
...
const footerBg = "/assets/wind-turbines-valor-By94bg8W.jpg";
const NAV_LINKS = [
  { to: "/", labelKey: "nav.home" },
  { to: "/sobre", labelKey: "nav.about" },
