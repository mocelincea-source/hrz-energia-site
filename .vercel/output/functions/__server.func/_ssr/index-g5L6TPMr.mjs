...
import { S as SiteShell } from "./raio-solid-gradient-GTBaP_To.mjs";
import { e as easeOut, b as HERO_VIDEO_REVEAL, l as logoWhite, c as HERO_DURATION, d as HERO_BASE, f as HERO_STAGGER, C as Counter, R as Reveal, S as Stagger, a as StaggerItem, H as HoverLift, P as Parallax } from "./router-Chp-NBHS.mjs";
...
import { S as ShieldCheck, A as Activity, Z as Zap, W as Wind, b as ArrowRight, s as Earth, t as ExternalLink, U as Users, u as HeartHandshake, L as Leaf } from "../_libs/lucide-react.mjs";
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteShell, { headerVariant: "dark", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-hrz relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { className: "mx-auto max-w-3xl text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "display-mega mt-4 text-4xl font-light text-foreground sm:text-5xl lg:text-6xl", children: [
            ...
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.act.is/", target: "_blank", rel: "noopener noreferrer", className: "font-normal text-hrz-electric transition-opacity duration-300 hover:underline hover:opacity-80", children: t("home.actis.heading2") })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { className: "mx-auto mt-12 max-w-2xl rounded-2xl border border-border/60 bg-card p-8 sm:p-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-base leading-relaxed text-muted-foreground", children: t("home.actis.body1") }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-col items-center justify-center gap-5 sm:flex-row sm:gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://www.act.is/", target: "_blank", rel: "noopener noreferrer", className: "group inline-flex items-center gap-2 rounded-full border border-hrz-electric/35 bg-transparent px-6 py-3 text-sm font-semibold text-hrz-electric transition-all duration-300 hover:border-hrz-electric/55 hover:bg-hrz-electric/[0.06]", children: [
            t("home.actis.websiteCta"),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { size: 15, strokeWidth: 1.75, className: "opacity-70 transition-opacity duration-300 group-hover:opacity-100" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/empresas", className: "inline-flex items-center gap-2 text-sm font-semibold text-hrz-electric transition-all hover:gap-3", children: [
            t("home.actis.cta"),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { size: 16 })
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden py-28", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-hrz", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-14 lg:grid-cols-[1.1fr_1fr] lg:items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
