...
const MAP_POINTS = [
  ...
  { name: "MGTE", dotX: 52, dotY: 32.5, labelX: 72, labelY: 30, side: "right", delay: 0.12 },
  { name: "Babilônia", dotX: 55.5, dotY: 44.5, labelX: 22, labelY: 42, side: "left", delay: 0.18 },
  { name: "AVT", dotX: 56, dotY: 56, labelX: 74, labelY: 46, side: "right", delay: 0.24 },
  ...
  { name: "Litoral Sul Transmissão", dotX: 50, dotY: 75, labelX: 22, labelY: 88, side: "left", delay: 0.48 },
  { name: "Vineyards", dotX: 46, dotY: 77.5, labelX: 22, labelY: 78, side: "left", delay: 0.54 }
];
