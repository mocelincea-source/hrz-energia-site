...
import { R as Reveal, F as Float } from "./router-BNNZhwE6.mjs";
import { B as BoltDecor } from "./BoltDecor-CQSogp3n.mjs";
import "../_libs/i18next.mjs";
import { u as useTranslation } from "../_libs/react-i18next.mjs";
import { n as Mail, M as MapPin, B as Building2, e as Linkedin, o as User, P as Phone, p as Briefcase, q as CircleCheck, r as Upload } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden py-24", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-hrz relative grid gap-12 lg:grid-cols-[1.1fr_1fr]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { delay: 0.1, className: "space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ContactCard, { icon: Building2, title: t("contact.cards.controllerTitle"), text: t("contact.cards.controllerValue") }),
...
function LiderancaSection() {
  ...
  const items = t("contact.leadership.items", {
    returnObjects: true
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden py-24", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-hrz relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3", children: items.map((exec) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative flex flex-col overflow-hidden rounded-2xl border border-border/60 bg-card p-6 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-hrz-electric/40 hover:shadow-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pointer-events-none absolute inset-y-0 left-0 w-[3px] origin-top scale-y-0 bg-gradient-to-b from-hrz-electric to-hrz-deep transition-transform duration-500 group-hover:scale-y-100" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-hrz-deep to-hrz-electric text-white shadow-md ring-1 ring-hrz-electric/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 20 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-base font-bold text-foreground leading-tight", children: exec.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-wider text-hrz-electric", children: exec.role })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${exec.phone.replace(/\s/g, "")}`, className: "flex items-center gap-3 text-sm text-muted-foreground transition hover:text-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 14, className: "shrink-0 text-hrz-electric" }),
            exec.phone
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `mailto:${exec.email}`, className: "flex items-center gap-3 break-all text-sm text-muted-foreground transition hover:text-foreground", children: [
