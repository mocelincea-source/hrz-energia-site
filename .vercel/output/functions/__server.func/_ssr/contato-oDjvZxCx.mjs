...
import { R as Reveal, F as Float } from "./router-BN0x4rgk.mjs";
import { B as BoltDecor } from "./BoltDecor-CIyKR1in.mjs";
import "../_libs/i18next.mjs";
import { u as useTranslation } from "../_libs/react-i18next.mjs";
import { n as Mail, M as MapPin, e as Linkedin, P as Phone, o as Briefcase, p as CircleCheck, q as Upload } from "../_libs/lucide-react.mjs";
...
function LiderancaSection() {
  ...
  const channel = t("contact.leadership.channel", {
    returnObjects: true
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden py-24", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-hrz relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { className: "mx-auto mt-10 max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative flex flex-col overflow-hidden rounded-2xl border border-border/60 bg-card p-8 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-hrz-electric/40 hover:shadow-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pointer-events-none absolute inset-y-0 left-0 w-[3px] origin-top scale-y-0 bg-gradient-to-b from-hrz-electric to-hrz-deep transition-transform duration-500 group-hover:scale-y-100" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-hrz-deep to-hrz-electric text-white shadow-md ring-1 ring-hrz-electric/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 20 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-base font-bold leading-tight text-foreground", children: channel.title }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${channel.phone.replace(/\s/g, "")}`, className: "flex items-center gap-3 text-sm text-muted-foreground transition hover:text-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 14, className: "shrink-0 text-hrz-electric" }),
            channel.phone
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `mailto:${channel.email}`, className: "flex items-center gap-3 break-all text-sm text-muted-foreground transition hover:text-foreground", children: [
