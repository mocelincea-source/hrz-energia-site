...
import { R as Reveal, P as Parallax, S as Stagger, a as StaggerItem, H as HoverLift } from "./router-CoUV5MU4.mjs";
import { r as raioBrand } from "./raio-hrz-CLnU4K00.mjs";
import "../_libs/i18next.mjs";
import { u as useTranslation } from "../_libs/react-i18next.mjs";
import { W as Wind, A as Activity, G as Gauge, v as Sun, L as Leaf, S as ShieldCheck, r as Sprout, m as Users, M as MapPin, b as ArrowRight } from "../_libs/lucide-react.mjs";
...
const complexMorroImg = "/assets/Complexo-Morro-do-Chap%C3%A9u-CZJ1xlBW.jpeg";
const complexOurolandiaImg = "/assets/Complexo-Ourol%C3%A2ndia-CPN7iIGJ.jpeg";
const complexVarzeaImg = "/assets/Complexo-V%C3%A1rzea-Nova-VeWNw5YP.jpeg";
...
function EolicasPage() {
  ...
  const COMPLEXOS = complexesData.map((item) => ({
    ...item,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-hrz", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 grid gap-8 lg:grid-cols-[1fr_1.4fr]", children: [
        ...
        sel && /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          duration: 0.45,
          ease: [0.22, 1, 0.36, 1]
        }, className: "relative min-h-[480px] overflow-hidden rounded-3xl border border-white/10 shadow-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": true, className: "absolute inset-0 bg-cover bg-center bg-no-repeat", style: {
            backgroundImage: `url(${sel.image})`
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": true, className: "absolute inset-0 bg-gradient-to-t from-black/60 via-black/50 to-black/40" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex min-h-[480px] flex-col justify-between p-7 lg:p-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "eyebrow text-white/90", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 11, className: "mr-1 inline" }),
                sel.municipio
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display mt-2 text-3xl font-bold text-white", children: sel.nome })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 space-y-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed text-white/90", children: sel.descricao }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: sel.destaques.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 text-sm text-white/95", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1.5 flex h-2 w-2 flex-none rounded-full bg-hrz-green-vivid" }),
                d
              ] }, d)) })
            ] })
          ] })
