...
import { S as SiteShell } from "./raio-solid-gradient-CmvUkfnx.mjs";
import { B as BoltDecor } from "./BoltDecor-nbSoyMw9.mjs";
import { R as Reveal, S as Stagger, a as StaggerItem } from "./router-CoUV5MU4.mjs";
...
const dashboardEsgImg = "/assets/DASHBOARD-CTVqRprO.jpg";
...
function EsgPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteShell, { headerVariant: "dark", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative flex min-h-[75vh] items-center overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroEsgImg, alt: "", "aria-hidden": true, fetchPriority: "high", decoding: "sync", className: "absolute inset-0 h-full w-full object-cover object-center" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "como-criamos-valor", className: "bg-slate-50 py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-hrz grid gap-12 lg:grid-cols-[1fr_1.4fr] lg:items-center lg:gap-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { viewportMargin: VIEWPORT_TRIGGER, delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display mt-4 text-3xl leading-tight tracking-tight text-foreground lg:text-4xl", children: t("esg.valueChain.title") }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { viewportMargin: VIEWPORT_TRIGGER, delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 max-w-md text-base leading-relaxed text-muted-foreground", children: t("esg.valueChain.description") }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { viewportMargin: VIEWPORT_TRIGGER, delay: 0.3, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#esg-pillars", className: "group mt-6 inline-flex items-center gap-1.5 text-sm font-medium text-hrz-green transition-colors hover:underline", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stagger, { fallbackDelay: 500, viewportMargin: VIEWPORT_TRIGGER, className: "flex flex-wrap items-start justify-center gap-4 lg:flex-nowrap lg:justify-end lg:gap-6", children: valueChainSteps.map((step, i) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "esg-inteligente", className: "bg-hrz-deep py-24 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-hrz", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stagger, { fallbackDelay: 500, viewportMargin: VIEWPORT_TRIGGER, staggerChildren: STAGGER_RHYTHM, className: "grid grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(StaggerItem, { className: "relative col-span-1 flex w-full items-center justify-center lg:col-span-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: dashboardEsgImg, alt: t("esg.smartEsg.dashboardAlt"), loading: "lazy", decoding: "async", className: `h-auto max-h-[500px] w-full object-contain object-center drop-shadow-[0_0_30px_rgba(0,0,0,0.5)] transition-transform duration-700 ease-out hover:scale-[1.02] ${GPU_LAYER}` }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StaggerItem, { className: "col-span-1 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Stagger, { fallbackDelay: 500, viewportMargin: VIEWPORT_TRIGGER, staggerChildren: STAGGER_RHYTHM, className: "grid grid-cols-1 gap-4 sm:grid-cols-2", children: smartEsgCards.map((card, i) => {
...
function SmartEsgCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex h-full flex-col rounded-xl border border-white/5 bg-white/[0.02] p-5 backdrop-blur-sm transition-all duration-300 ease-out hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.05] ${GPU_LAYER}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { size: 22, strokeWidth: 1.5, className: "text-hrz-green" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-2 font-semibold text-white", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs leading-relaxed text-slate-400", children: description })
  ] });
}
