...
const Cable = createLucideIcon("cable", __iconNode$t);
...
const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$k);
const __iconNode$j = [
  [
    "path",
    {
...
const MessageSquareWarning = createLucideIcon("message-square-warning", __iconNode$c);
const __iconNode$b = [
  [
    "path",
    {
